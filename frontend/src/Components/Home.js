import {
	...
	Text,
	useBreakpointValue,
	Box, SimpleGrid, Icon, useColorModeValue,
...
export default function Home() {
	...
	return (
		<>
			<Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }} justifyContent={'space-around'}>
				<Flex p={8} align={'center'} justify={'center'}>
					<Stack spacing={6} w={'full'} maxW={'lg'}>
						...
						<Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
							This project is being developed mainly to reduce the efforts and save the time of customer rushing to local shops for their daily needed products.
						</Text>
						<Stack direction={{ base: 'column', md: 'row' }} spacing={4}>
							<Button
								...
								onClick={() => {navigate('/displayshops')}}
								>
								Shop Now
							</Button>
							<Button rounded={'full'} onClick={() => {navigate('/cart')}}>
								Go to Cart
							</Button>
						</Stack>
					</Stack>
...
const FeaturesSection = () => {
	return (
		<Box p={4} mb={5}>
			<SimpleGrid columns={{ base: 1, md: 3 }} spacing={10} alignContent={'center'} justifyContent={'center'}>
				<Feature
