...
import { Box, Text, Center, Flex, useToast, useColorModeValue } from '@chakra-ui/react';
...
export default function Logout() {
	...
	const logoutFun = async () => {
		try {
			...
			const url = `${API}/api/logout${whoisLoggedIn === 'customer' ? 'Customer' : 'Shop'}`
	...
	return (
		<>
			<Flex mt={8} alignContent={'center'} justifyContent={'center'}>
				<Center>
					<Text as='h2' fontWeight={600} color={useColorModeValue('gray.700', 'white')}>
